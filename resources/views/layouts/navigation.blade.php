<nav x-data="{ open: false }" class="bg-fuchsia-400 border-b border-gray-100 dark:border-gray-700">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-fuchsia-400">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('vacancy.index') }}">
                        <x-application-logo class="rounded-full block h-20 w-auto font-bold font-mono" />
                    </a>
                </div>
